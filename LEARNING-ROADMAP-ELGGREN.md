...
- [x] I have set up hooks in ~/.claude/settings.json
- [x] I have created or used custom subagents (.claude/agents/)
- [x] I have used print mode (`claude -p`) for scripting or CI/CD
...
- [x] Can create and use slash commands ([01-slash-commands/](01-slash-commands/))
- [x] Have set up project memory via CLAUDE.md ([02-memory/](02-memory/))
- [x] Know how to create and restore checkpoints ([08-checkpoints/](08-checkpoints/))
- [x] Can use `claude` and `claude -p` from the command line ([10-cli/](10-cli/))
...
#### Success Criteria
- [x] Code review skill automatically invoked when relevant
- [x] PreToolUse hook runs before tool execution
- [k] You understand skill auto-invocation vs. hook event triggers
...
#### Success Criteria
- [x] Successfully query GitHub data via MCP
- [x] Claude delegates complex tasks to subagents
- [x] You understand the difference between MCP and subagents
- [x] Combined MCP + subagents + hooks in a workflow
...
- [x] Can create and use skills with auto-invocation ([03-skills/](03-skills/))
- [x] Have set up hooks for event-driven automation ([06-hooks/](06-hooks/))
- [x] Can configure MCP servers for external data ([05-mcp/](05-mcp/))
- [x] Know how to use subagents for task delegation ([04-subagents/](04-subagents/))
...
#### Success Criteria
- [x] Used planning mode for a complex feature
- [x] Configured permission modes (plan, acceptEdits, auto, dontAsk)
- [x] Toggled extended thinking with Alt+T / Option+T
- [x] Used auto mode with background safety classifier
- [x] Used background tasks for long operations
- [x] Explored Channels for multi-session workflows
- [ ] Tried Voice Dictation for hands-free input
- [x] Understand Remote Control, Desktop App, and Web sessions
...
#### Success Criteria
- [x] Installed and used a plugin
- [x] Built or modified a plugin for your team
- [x] Used print mode (`claude -p`) in CI/CD
- [x] Generated JSON output for scripting
- [x] Resumed a previous session successfully
